"""
Generates a 2-D unit ellips mesh with variable numbers of elements in 2 directions.
"""
...
class MeshType_2d_ellipse1(object):
    '''
    classdocs
    '''
    @staticmethod
    ...
    def getDefaultOptions():
        return {
            ...
            'Ratio Lobe width to lung width':0.8,
            'Length width':1,
            'Length depth':0.6,
    ...
    def getOrderedOptionNames():
        return [
            ...
            'Ratio Lobe width to lung width',
            'Length width'
            'Length depth'
    ...
    def checkOptions(options):
        ...
        if ((options['Ratio Lobe width to lung width']>1) or
                (['Ratio Lobe width to lung width']<=0)):
            options['Ratio Lobe width to lung width']=0.8
        if (options['Length width']<=0):
            options['Length width']=1
        if (options['Length depth']<=0):
            options['Length width'] = 0.6
    ...
    def generateMesh(region, options):
        ...
        RatioLobeWidthToLungWidth=options['Ratio Lobe width to lung width']
        LengthWidth=options['Length width']
        LengthDepth=options['Length depth']
        ...
        for n2 in range(elementsCount2 + 1):
            x[1] = n2 *((RatioLobeWidthToLungWidth*LengthWidth+(LengthWidth/2.0))/elementsCount2)-LengthWidth
