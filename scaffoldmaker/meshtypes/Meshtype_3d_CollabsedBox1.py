...
class MeshType_3d_CollabsedBox1(object):
    '''
    classdocs
    '''
    @staticmethod
    def getName():
        return '3D CollapsedBox 1'
    ...
    def generateBaseMesh(region, options):
        ...
        for n3 in range(elementsCount3 + 1):
            ...
            for n2 in range(elementsCount2 + 1):
                ...
                x[1] = (n2 / elementsCount2)*math.sin(math.radians(60))
                for n1 in range(elementsCount1 + 1):
                    x[0] =(n2 / elementsCount2)*math.cos(math.radians(60))+ \
                          (((elementsCount2-n2) / elementsCount2)/elementsCount1)*n1
